...
var _aguspagnoni$snake_in_elm$Main$shortName = function (s) {
	return _elm_lang$core$String$toUpper(
		A3(_elm_lang$core$String$slice, 0, 1, s));
};
var _aguspagnoni$snake_in_elm$Main$textColor = A3(_elm_lang$core$Color$rgb, 90, 120, 127);
var _aguspagnoni$snake_in_elm$Main$borderColor = A3(_elm_lang$core$Color$rgb, 88, 80, 79);
var _aguspagnoni$snake_in_elm$Main$fieldColor = A3(_elm_lang$core$Color$rgb, 234, 247, 196);
var _aguspagnoni$snake_in_elm$Main$txt = F2(
	function (msg, color) {
...
var _aguspagnoni$snake_in_elm$Main$view = function (model) {
	...
	var border = A2(
		...
		_elm_lang$core$Native_Utils.update(
			_evancz$elm_graphics$Collage$defaultLine,
			{width: _aguspagnoni$snake_in_elm$Main$borderSize, color: _elm_lang$core$Color$black}),
		A2(
			_evancz$elm_graphics$Collage$rect,
			_elm_lang$core$Basics$toFloat(_aguspagnoni$snake_in_elm$Main$width),
			_elm_lang$core$Basics$toFloat(_aguspagnoni$snake_in_elm$Main$height)));
	var bg = A2(
		_evancz$elm_graphics$Collage$filled,
		_aguspagnoni$snake_in_elm$Main$fieldColor,
		A2(
			_evancz$elm_graphics$Collage$rect,
			_elm_lang$core$Basics$toFloat(_aguspagnoni$snake_in_elm$Main$width),
			_elm_lang$core$Basics$toFloat(_aguspagnoni$snake_in_elm$Main$height)));
	return _evancz$elm_graphics$Element$toHtml(
		A3(
			...
			_aguspagnoni$snake_in_elm$Main$width,
			_aguspagnoni$snake_in_elm$Main$height,
			A2(
				_elm_lang$core$List_ops['::'],
				bg,
...
var _aguspagnoni$snake_in_elm$Main$Right = {ctor: 'Right'};
var _aguspagnoni$snake_in_elm$Main$Left = {ctor: 'Left'};
var _aguspagnoni$snake_in_elm$Main$Down = {ctor: 'Down'};
var _aguspagnoni$snake_in_elm$Main$initPlayer = F2(
	function (name, iniPos) {
		...
		return {
			...
			tail: _elm_lang$core$Native_List.fromArray(
				[]),
			direction: _aguspagnoni$snake_in_elm$Main$Down,
			name: name
		};
	});
...
var _aguspagnoni$snake_in_elm$Main$init = {
	ctor: '_Tuple2',
	_0: _aguspagnoni$snake_in_elm$Main$NotStarted(''),
	...
	function (msg, model) {
		...
		if (_p16.ctor === 'NotStarted') {
			...
			if (_p18.ctor === 'KeyPress') {
				...
				return gameOver1 ? {
					ctor: '_Tuple2',
					_0: _aguspagnoni$snake_in_elm$Main$NotStarted(p2$.name),
					_1: _elm_lang$core$Platform_Cmd$none
				} : (gameOver2 ? {
					ctor: '_Tuple2',
					_0: _aguspagnoni$snake_in_elm$Main$NotStarted(p1$.name),
					_1: _elm_lang$core$Platform_Cmd$none
				} : {
					ctor: '_Tuple2',
					_0: _aguspagnoni$snake_in_elm$Main$Started(
...
var _aguspagnoni$snake_in_elm$Main$KeyPress = function (a) {
	return {ctor: 'KeyPress', _0: a};
};
var _aguspagnoni$snake_in_elm$Main$Tick = function (a) {
...
var _aguspagnoni$snake_in_elm$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _aguspagnoni$snake_in_elm$Main$init, view: _aguspagnoni$snake_in_elm$Main$view, update: _aguspagnoni$snake_in_elm$Main$update, subscriptions: _aguspagnoni$snake_in_elm$Main$subscriptions})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _aguspagnoni$snake_in_elm$Main$main === 'undefined' ? null : _aguspagnoni$snake_in_elm$Main$main);
