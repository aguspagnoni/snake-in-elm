...
var _liubko$elm_snake$Main$borderSize = _liubko$elm_snake$Main$segmentDim;
var _liubko$elm_snake$Main$isGameOver = F2(
	function (p1, p2) {
		return A2(
			_elm_lang$core$List$any,
			F2(
			...
			(0 - _liubko$elm_snake$Main$borderSize) + (_liubko$elm_snake$Main$width / 2)) > 0) || ((_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$snd(p1.head),
			(0 - _liubko$elm_snake$Main$borderSize) + (_liubko$elm_snake$Main$height / 2)) > 0) || ((_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$fst(p1.head),
			_liubko$elm_snake$Main$borderSize - (_liubko$elm_snake$Main$width / 2)) < 0) || (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$snd(p1.head),
			_liubko$elm_snake$Main$borderSize - (_liubko$elm_snake$Main$height / 2)) < 0))));
	});
var _liubko$elm_snake$Main$view = function (model) {
	...
	var border = A2(
		...
		_elm_lang$core$Native_Utils.update(
			_evancz$elm_graphics$Collage$defaultLine,
			{width: _liubko$elm_snake$Main$borderSize, color: _elm_lang$core$Color$black}),
		A2(
			_evancz$elm_graphics$Collage$rect,
			_elm_lang$core$Basics$toFloat(_liubko$elm_snake$Main$width),
			_elm_lang$core$Basics$toFloat(_liubko$elm_snake$Main$height)));
	var bg = A2(
		_evancz$elm_graphics$Collage$filled,
		_liubko$elm_snake$Main$fieldColor,
		A2(
			_evancz$elm_graphics$Collage$rect,
			_elm_lang$core$Basics$toFloat(_liubko$elm_snake$Main$width),
			_elm_lang$core$Basics$toFloat(_liubko$elm_snake$Main$height)));
	return _evancz$elm_graphics$Element$toHtml(
		A3(
			...
			_liubko$elm_snake$Main$width,
			_liubko$elm_snake$Main$height,
			A2(
				_elm_lang$core$List_ops['::'],
				bg,
				A2(_elm_lang$core$List_ops['::'], border, content))));
};
var _liubko$elm_snake$Main$getNewSegment = F2(
	function (_p5, direction) {
		...
		switch (_p7.ctor) {
			case 'Up':
				return A2(_liubko$elm_snake$Main$pos, _p8, _p9 + _liubko$elm_snake$Main$segmentDim);
			case 'Down':
				return A2(_liubko$elm_snake$Main$pos, _p8, _p9 - _liubko$elm_snake$Main$segmentDim);
			case 'Left':
				return A2(_liubko$elm_snake$Main$pos, _p8 - _liubko$elm_snake$Main$segmentDim, _p9);
			default:
				return A2(_liubko$elm_snake$Main$pos, _p8 + _liubko$elm_snake$Main$segmentDim, _p9);
		}
	});
var _liubko$elm_snake$Main$Player = F4(
	function (a, b, c, d) {
		return {head: a, tail: b, direction: c, name: d};
	});
var _liubko$elm_snake$Main$Right = {ctor: 'Right'};
var _liubko$elm_snake$Main$Left = {ctor: 'Left'};
			...
			switch (_p13.valueOf()) {
				case 'a':
					return {
						ctor: '_Tuple3',
						_0: _elm_lang$core$Native_List.fromArray(
							[_liubko$elm_snake$Main$Up, _liubko$elm_snake$Main$Down]),
						_1: _liubko$elm_snake$Main$Left,
						_2: _p14
					};
				case 'w':
					return {
						ctor: '_Tuple3',
						_0: _elm_lang$core$Native_List.fromArray(
							[_liubko$elm_snake$Main$Left, _liubko$elm_snake$Main$Right]),
						_1: _liubko$elm_snake$Main$Up,
						_2: _p14
					};
				case 'd':
					return {
						...
						_0: _elm_lang$core$Native_List.fromArray(
							[_liubko$elm_snake$Main$Up, _liubko$elm_snake$Main$Down]),
						_1: _liubko$elm_snake$Main$Right,
						_2: _p14
					};
				case 's':
					return {
						...
						_0: _elm_lang$core$Native_List.fromArray(
							[_liubko$elm_snake$Main$Left, _liubko$elm_snake$Main$Right]),
						_1: _liubko$elm_snake$Main$Down,
						_2: _p14
					};
				case 'j':
					return {
...
var _liubko$elm_snake$Main$Started = function (a) {
	return {ctor: 'Started', _0: a};
};
var _liubko$elm_snake$Main$NotStarted = function (a) {
	return {ctor: 'NotStarted', _0: a};
};
var _liubko$elm_snake$Main$init = {
	ctor: '_Tuple2',
	_0: _liubko$elm_snake$Main$NotStarted(''),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _liubko$elm_snake$Main$update = F2(
	function (msg, model) {
		var _p16 = model;
		if (_p16.ctor === 'NotStarted') {
			...
			if ((_p17.ctor === 'KeyPress') && (_p17._0 === 32)) {
				return {
					ctor: '_Tuple2',
					_0: _liubko$elm_snake$Main$Started(
						{
							ctor: '_Tuple2',
							_0: A2(
			...
			if (_p18.ctor === 'KeyPress') {
				var _p19 = A2(
					_liubko$elm_snake$Main$getNewDirection,
					_p18._0,
				...
				var newHead2 = A2(_liubko$elm_snake$Main$getNewSegment, _p21.head, _p21.direction);
				var p2$ = _elm_lang$core$Native_Utils.update(
					_p21,
					{head: newHead2, tail: newTail2});
				var newHead1 = A2(_liubko$elm_snake$Main$getNewSegment, _p20.head, _p20.direction);
				var p1$ = _elm_lang$core$Native_Utils.update(
					_p20,
					{head: newHead1, tail: newTail1});
				var gameOver1 = A2(_liubko$elm_snake$Main$isGameOver, p1$, p2$);
...
var _liubko$elm_snake$Main$KeyPress = function (a) {
	return {ctor: 'KeyPress', _0: a};
};
var _liubko$elm_snake$Main$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _liubko$elm_snake$Main$subscriptions = function (model) {
	var _p22 = model;
	if (_p22.ctor === 'NotStarted') {
		return _elm_lang$keyboard$Keyboard$presses(_liubko$elm_snake$Main$KeyPress);
	} else {
...
var _liubko$elm_snake$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _liubko$elm_snake$Main$init, view: _liubko$elm_snake$Main$view, update: _liubko$elm_snake$Main$update, subscriptions: _liubko$elm_snake$Main$subscriptions})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _liubko$elm_snake$Main$main === 'undefined' ? null : _liubko$elm_snake$Main$main);
